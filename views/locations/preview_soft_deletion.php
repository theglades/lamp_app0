...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <form class="form-group" action="/locations/preview_soft_deletion/{$location->id}" method="POST">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="confirm_soft_deletion_of_location" placeholder="NO">
        </div>
